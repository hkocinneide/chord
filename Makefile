...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Fri Nov 7 13:10:48 2014
# Project:  chord.pro
# Template: app
...
Makefile: chord.pro  /usr/lib64/qt4/mkspecs/linux-g++/qmake.conf /usr/lib64/qt4/mkspecs/common/unix.conf \
		/usr/lib64/qt4/mkspecs/common/linux.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/lib64/qt4/mkspecs/common/g++-base.conf \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/chord1.0.0/ && $(COPY_FILE) --parents main.hh .tmp/chord1.0.0/ && $(COPY_FILE) --parents main.cc .tmp/chord1.0.0/ && (cd `dirname .tmp/chord1.0.0` && $(TAR) chord1.0.0.tar chord1.0.0 && $(COMPRESS) chord1.0.0.tar) && $(MOVE) `dirname .tmp/chord1.0.0`/chord1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/chord1.0.0
